...
public class Activator implements BundleActivator, ServiceListener {
    ...
    private void registerAddons() {
        if (serviceManager != null) {
            serviceManager.registerClass(JettyStandaloneHttpServer.class);
			serviceManager.registerClass(JettyOSGiHttpServer.class);
    ...
    private void unregisterAddons() {
        if (serviceManager != null) {
            serviceManager.unregisterClass(JettyStandaloneHttpServer.class);
			serviceManager.unregisterClass(JettyOSGiHttpServer.class);
			serviceManager.update();
        }
    }
